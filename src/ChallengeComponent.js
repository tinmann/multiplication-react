        ...
        ApiClient.sendGuess(this.state.user,
            ...
            .then(res => {
                if(res.ok) {
                    res.json().then(json => {
                        if(json.correct) {
                            this.updateMessage("Congradulations! Your guess is correct");
                        }
                        else {
                            this.updateMessage("Oops! Your guess "+ json.resultAttempt +" is wrong!");
                        }
                        this.updateLastAttempts(this.state.user);
                        this.refreshChallenge();
                    });
                } else {
                    this.updateMessage("Error: Server error");
                }
            });
    }
